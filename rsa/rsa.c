...
int1024 ** rsa_create_key(int key_len){// return [e, n, d, p, q]
    int1024 * p, * q, * n;
    p = int1024_get_prime(key_len);
    q = int1024_get_prime(key_len);
    n = int1024_mul(q, p);
    int1024 * p_1, * q_1;
    ...
    free(q_1);free(p_1);
    int1024 * e;
    e = int1024_get_prime(key_len);
    int1024_powto(e, (int1024 *)1, psi_n);
    int1024 * d;
    ...
    free(psi_n);
    int1024 ** result;
    result = (int1024 **)calloc(1, sizeof(int1024 *) * 5);
    result[0] = e;
    result[1] = n;
    result[2] = d;
    result[3] = p;
